...
<template>
  <div class="h-panel account-info-show-vue">
    <div class="h-panel-body">
      ...
      <p class="account-desc"><pre>安庆师范大学</pre></p>
      <div class="account-detail-desc">
        <p><i class="icon-head"></i><span>{{account.id}}</span></p>
        <p><i class="icon-file"></i><span>{{account.department}}</span></p>
        <p><i class="icon-book"></i><span>{{account.major}}</span></p>
        <p><i class="icon-briefcase"></i><span>{{account.classNum}}</span></p>
      </div>
